...
//    baseUrl: 'http://192.168.5.208:8000/Jia/',
    ...
    onError: ( DioError e, ErrorInterceptorHandler handler,){
      print("请求前 错误onResponse${e.message}");
      print("请求前 错误onResponse${e.error}");
      print("请求前 错误onResponse${e.response}");
      print("请求前 错误onResponse${e.requestOptions}");
      print("请求前 错误onResponse${e.requestOptions.queryParameters}");
      print("请求前 错误onResponse${e.requestOptions.data}");
      print("请求前 错误onResponse${e.requestOptions.uri}");
    }
  ));
